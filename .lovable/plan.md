...
1. **Visibilidad inmediata en Estampación**
   La pestaña "Por ingresar" deja de exigir que Diseño haya aprobado el logo. Muestra todo pedido nuevo con logo o personalización, de Magical Warmers y Sweatspot, ordenado por antigüedad y con los días de espera. Si el logo todavía está en Diseño, se ve una etiqueta que lo indica, pero el pedido ya está a la vista.
